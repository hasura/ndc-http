...
func TestCreateFormURLEncoded(t *testing.T) {
	testCases := []struct {
        ...
        "body": {
          ...
          "ui_mode": "hosted"
			...
			//         invoice_creation[invoice_data][description]=MiePp9LfkQ&line_items[0][price_data][product_data][tax_code]=PzbIHvqWJp&line_items[0][price_data][unit_amount_decimal]=vkJPCvrn9Q&subscription_data[transfer_data][amount_percent]=1.5805719275050356&payment_method_options[paypal][risk_correlation_id]=fj1J6Nux6P&payment_method_options[acss_debit][mandate_options][custom_mandate_url]=FZwPtJKktL&payment_method_options[sepa_debit][setup_future_usage]=none&custom_fields[0][type]=dropdown&invoice_creation[enabled]=true&payment_intent_data[shipping][carrier]=P8mCJlEq1J&payment_method_options[acss_debit][currency]=usd&subscription_data[on_behalf_of]=oGsMnSifXV&custom_text[shipping_address][message]=XeD5TkmC8k&payment_intent_data[application_fee_amount]=2033958571&payment_intent_data[description]=yoalRHw9ZG&shipping_options[0][shipping_rate_data][fixed_amount][currency]=KkRL3jvZMO&payment_method_options[paypal][preferred_locale]=cs-CZ&payment_method_options[konbini][expires_after_days]=664583520&custom_text[after_submit][message]=b7ifuedi9S&allow_promotion_codes=true&custom_fields[0][dropdown][options][0][value]=hXN8MppU0k&invoice_creation[invoice_data][custom_fields][0][value]=EWoKgkV3fg&line_items[0][price_data][recurring][interval]=day&payment_method_options[customer_balance][setup_future_usage]=none&invoice_creation[invoice_data][account_tax_ids][]=dev8vFF6xG&line_items[0][price_data][unit_amount]=945322526&shipping_options[0][shipping_rate_data][delivery_estimate][maximum][value]=479399576&shipping_options[0][shipping_rate_data][display_name]=PXozGQQnBA&payment_method_options[paynow][setup_future_usage]=none&payment_method_options[oxxo][expires_after_days]=1925345768&payment_intent_data[transfer_data][amount]=94957585&payment_intent_data[transfer_data][destination]=LrcNMrJPkO&shipping_options[0][shipping_rate_data][tax_behavior]=exclusive&shipping_options[0][shipping_rate_data][type]=fixed_amount&payment_method_options[customer_balance][bank_transfer][requested_address_types][]=iban&custom_fields[0][numeric][maximum_length]=678468035&invoice_creation[invoice_data][issuer][account]=aqOwDzxnyg&invoice_creation[invoice_data][issuer][type]=account&line_items[0][adjustable_quantity][enabled]=false&payment_method_options[acss_debit][mandate_options][interval_description]=iMgay8S9If&payment_method_options[swish][reference]=rXJq1EX4rc&subscription_data[description]=7mpaD2E0jf&subscription_data[trial_period_days]=1684102049&after_expiration[recovery][enabled]=true&shipping_address_collection[allowed_countries][]=AC&cancel_url=qpmWppPyIv&payment_intent_data[shipping][tracking_number]=XGOZIrLZf0&automatic_tax[liability][type]=self&payment_method_options[eps][setup_future_usage]=none&custom_fields[0][numeric][minimum_length]=2134997439&payment_intent_data[statement_descriptor_suffix]=dtPJwyuc4i&discounts[0][promotion_code]=Xknj8juRnm&payment_method_options[boleto][expires_after_days]=953467886&payment_method_options[bancontact][setup_future_usage]=none&payment_method_options[wechat_pay][setup_future_usage]=none&custom_fields[0][dropdown][options][0][label]=W3oysCi31d&invoice_creation[invoice_data][custom_fields][0][name]=LBlZjJ4gEy&payment_method_options[paypal][capture_method]=manual&payment_method_options[pix][expires_after_seconds]=191312234&subscription_data[trial_settings][end_behavior][missing_payment_method]=create_invoice&customer_email=1xiCJ8M7Pr&customer_update[address]=never&payment_intent_data[shipping][address][postal_code]=1aAilmcYiq&payment_method_options[card][statement_descriptor_suffix_kanji]=Y57zexRcIH&payment_method_options[paypal][setup_future_usage]=none&payment_method_options[afterpay_clearpay][setup_future_usage]=none&automatic_tax[liability][account]=gW7D0WhP9C&payment_method_options[us_bank_account][setup_future_usage]=none&subscription_data[proration_behavior]=create_prorations&custom_text[submit][message]=vGcSz5eSlo&tax_id_collection[enabled]=true&payment_intent_data[shipping][address][line2]=CM9x9Jizzu&payment_intent_data[statement_descriptor]=JCOo6lU8Fy&payment_intent_data[receipt_email]=LxJLYGjJ4r&shipping_options[0][shipping_rate]=5PAjqTpMjw&payment_method_options[card][statement_descriptor_suffix_kana]=ZvJtIONyDK&payment_method_options[p24][setup_future_usage]=none&payment_method_options[acss_debit][mandate_options][transaction_type]=business&payment_method_options[alipay][setup_future_usage]=none&subscription_data[billing_cycle_anchor]=1981798554&expires_at=1756067225&payment_intent_data[shipping][address][city]=v6nZI33cUt&shipping_options[0][shipping_rate_data][tax_code]=NKSQxYdCfO&payment_method_configuration=uwYSwIZP4V&line_items[][price_data][product_data][images][]=gE5K8MOzRc&line_items[0][quantity]=968305911&line_items[][tax_rates][]=Ts1bPAoT0T&line_items[0][adjustable_quantity][maximum]=1665059759&line_items[0][adjustable_quantity][minimum]=905088217&shipping_options[0][shipping_rate_data][delivery_estimate][minimum][value]=1640284987&consent_collection[terms_of_service]=required&payment_method_options[klarna][setup_future_usage]=none&payment_method_options[cashapp][setup_future_usage]=off_session&line_items[0][price_data][product_data][name]=ak6UVjXl1B&line_items[0][price_data][recurring][interval_count]=592739346&consent_collection[payment_method_reuse_agreement][position]=auto&billing_address_collection=auto&payment_intent_data[shipping][phone]=CWAbvZM4Kw&setup_intent_data[on_behalf_of]=165u5Fvodj&payment_method_options[boleto][setup_future_usage]=none&payment_method_options[revolut_pay][setup_future_usage]=off_session&subscription_data[application_fee_percent]=1.7020678102144877&subscription_data[invoice_settings][issuer][account]=axhiYamJKY&payment_intent_data[shipping][name]=mJYqgRIh3S&line_items[][dynamic_tax_rates][]=jMMvH8TmQD&line_items[0][price_data][currency]=euIDO8C4A7&custom_fields[0][optional]=false&custom_fields[0][text][maximum_length]=331815114&submit_type=donate&payment_method_options[us_bank_account][financial_connections][permissions][]=ownership&payment_method_options[customer_balance][funding_type]=bank_transfer&phone_number_collection[enabled]=true&subscription_data[invoice_settings][issuer][type]=account&subscription_data[default_tax_rates][]=b3jgFBJq4f&payment_method_options[paypal][reference]=ulLn2NXA1P&payment_method_options[wechat_pay][app_id]=9Pu0d1pZ2r&payment_intent_data[transfer_group]=XKfPQPVhOT&redirect_on_completion=never&line_items[0][price_data][product]=xilQ2QDVdA&payment_method_options[us_bank_account][financial_connections][prefetch][]=transactions&customer=mT4BKOSu9s&payment_method_options[card][installments][enabled]=true&payment_method_options[ideal][setup_future_usage]=none&payment_method_options[fpx][setup_future_usage]=none&payment_method_options[bacs_debit][setup_future_usage]=off_session&custom_fields[0][label][type]=custom&customer_update[shipping]=auto&discounts[0][coupon]=tOlEXiZKv9&expand[]=ZBxEXz7SN0&payment_method_options[us_bank_account][verification_method]=automatic&payment_method_options[customer_balance][bank_transfer][type]=gb_bank_transfer&custom_fields[0][label][custom]=uabTz3xzdn&customer_update[name]=never&line_items[0][price]=fR6vnvprv8&shipping_options[0][shipping_rate_data][delivery_estimate][minimum][unit]=day&payment_method_collection=always&custom_fields[0][key]=5ZeyjIHLn8&invoice_creation[invoice_data][footer]=OAELqbYbKV&invoice_creation[invoice_data][rendering_options][amount_tax_display]=exclude_tax&payment_method_options[grabpay][setup_future_usage]=none&payment_method_options[p24][tos_shown_and_accepted]=true&payment_method_options[konbini][setup_future_usage]=none&subscription_data[trial_end]=606476058&customer_creation=always&setup_intent_data[description]=U9qFTQnt1W&shipping_options[0][shipping_rate_data][fixed_amount][amount]=2040036333&success_url=hDTwi34TAz&payment_method_options[giropay][setup_future_usage]=none&payment_method_options[wechat_pay][client]=ios&return_url=YgIdKykEHC&payment_intent_data[capture_method]=manual&payment_method_types[]=acss_debit&payment_method_options[acss_debit][mandate_options][default_for][]=invoice&payment_method_options[acss_debit][verification_method]=instant&payment_method_options[oxxo][setup_future_usage]=none&custom_fields[0][text][minimum_length]=1689246767&ui_mode=hosted&client_reference_id=ZcJeCf6JAa&line_items[0][price_data][tax_behavior]=inclusive&automatic_tax[enabled]=false&payment_method_options[card][setup_future_usage]=on_session&payment_method_options[acss_debit][mandate_options][payment_schedule]=sporadic&subscription_data[transfer_data][destination]=wzJ3U1Tyhd&after_expiration[recovery][allow_promotion_codes]=true&line_items[0][price_data][product_data][description]=DQECtJEsLI&mode=payment&payment_method_options[acss_debit][setup_future_usage]=off_session&currency=oVljMB8lon&payment_intent_data[shipping][address][line1]=3YghEmysVn&payment_intent_data[shipping][address][state]=ILODDWP1IP&payment_method_options[affirm][setup_future_usage]=none&payment_method_options[link][setup_future_usage]=none&locale=auto&payment_intent_data[shipping][address][country]=O8MBVcia7c&shipping_options[0][shipping_rate_data][delivery_estimate][maximum][unit]=week&consent_collection[promotions]=auto&custom_text[terms_of_service_acceptance][message]=zGLTTZItPl&payment_intent_data[on_behalf_of]=mpkGzXu3st&payment_intent_data[setup_future_usage]=off_session&payment_method_options[card][request_three_d_secure]=any&payment_method_options[au_becs_debit][setup_future_usage]=none&payment_method_options[sofort][setup_future_usage]=none&payment_method_options[customer_balance][bank_transfer][eu_bank_transfer][country]=mzrVWAjBTc
		},
		{
			Name: "PostCheckoutSessions",
			RawArguments: `{
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			builder := NewURLParameterEncoder(ndcSchema, info.Request.RequestBody)
